...
interface dayjs {
  (date?: ConfigType): Day;
  (date?: ConfigType, format?: OptionType, strict?: boolean): Day
  (date?: ConfigType, format?: OptionType, locale?: string, strict?: boolean): Day
}
...
interface Day {
   ...
   */
  set(unit: UnitType, value: number): Day
  /**
   ...
   */
  subtract(value: number, unit?: ManipulateType): Day
  /**
  ...
  locale(preset: string | ILocale, object?: Partial<ILocale>): Day
}

declare var dayjs: dayjs;
